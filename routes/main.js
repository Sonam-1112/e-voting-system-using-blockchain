...
{/* <script type="module" src='./login-route.js'></script> */}
/* GET users listing. */
// import { email } from './login-route';
...
var transporter = nodemailer.createTransport({
    service: 'gmail',
    auth: {
      user: 'sonamg2002@gmail.com',
      pass: 'ydrvpogjbgnjzzck'
    }
  });
...
router.post('/registerdata',function(req,res){
    ...
    var sqt = 'INSERT INTO aadhar_info SET ?';
    console.log(sqt);
    conn.query(sqt, inputData, function (err, data) {
